...
public class Scenario {
	...
	public static void main(String[] args) {
		...
		village.setChef(abraracourcix); //mettre en commentaire pour tester l'exception personnalisée d'afficherVillageois 
		...
		//etal.occuperEtal(assurancetourix,"fleurs", 10);
		//etal.acheterProduit(5, bonemine);
		//village.afficherVillageois();
	}
